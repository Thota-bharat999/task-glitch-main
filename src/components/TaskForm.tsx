...
// 👇 Correct payload type (Form does not send createdAt / completedAt)
type TaskPayload = Omit<Task, 'id' | 'createdAt' | 'completedAt'> & { id?: string };

interface Props {
  open: boolean;
  onClose: () => void;
  onSubmit: (value: TaskPayload) => void;   // 👈 updated
